 ...
 * for inclusion in other projects. Simplified equivalent of play_models.py.
 * No multiprocessing, no gnubg -- just two models head-to-head.
 *
 * Quick start (from the c_inference/ directory):
 *
 *   # Build
 *   bash build_play.sh
 *
 *   # Export a model
 *   python ../export_weights.py ../best_models/td_batch_relu_512_512_256_128_1ply_vi_final.pt model.bin
 *
 *   # Verify C matches Python
 *   ./test_nn model.bin
 *
 *   # Play two models (100 games)
 *   ./play_models model.bin model.bin 100
 */
